...
import { getProfesores } from "../composables/useDatabase"; // Asegúrate de importar correctamente
            ...
            <div class="space-y-4">
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input v-model="form.nombre_oficial" id="nombre_oficial" type="text"
                    class="w-full rounded-lg border-gray-200 focus:border-purple-500 focus:ring-purple-500 p-3 text-sm shadow-sm"
                    placeholder="Nombre oficial de la empresa" />
                </div>

                <div>
                  <label for="direccion_sede_central" class="block text-sm font-medium text-gray-700">Dirección Sede
                    Central</label>
                  <input v-model="form.direccion_sede_central" id="direccion_sede_central" type="text"
                    class="w-full rounded-lg border-gray-200 focus:border-purple-500 focus:ring-purple-500 p-3 text-sm shadow-sm"
                    placeholder="Dirección de la sede central" />
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input v-model="form.poblacion" id="poblacion" type="text"
                    class="w-full rounded-lg border-gray-200 focus:border-purple-500 focus:ring-purple-500 p-3 text-sm shadow-sm"
                ...
                <div>
                  ...
                  <input v-model="form.codigo_postal" id="codigo_postal" type="text"
                    class="w-full rounded-lg border-gray-200 focus:border-purple-500 focus:ring-purple-500 p-3 text-sm shadow-sm"
              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input v-model="form.provincia" id="provincia" type="text"
                    class="w-full rounded-lg border-gray-200 focus:border-purple-500 focus:ring-purple-500 p-3 text-sm shadow-sm"
                ...
                <div>
                  ...
                  <input v-model="form.telefono_empresa" id="telefono_empresa" type="tel"
                    class="w-full rounded-lg border-gray-200 focus:border-purple-500 focus:ring-purple-500 p-3 text-sm shadow-sm"
              ...
              <div>
                <label for="actividad_principal" class="block text-sm font-medium text-gray-700">Actividad
                  Principal</label>
                <input v-model="form.actividad_principal" id="actividad_principal" type="text"
                  class="w-full rounded-lg border-gray-200 focus:border-purple-500 focus:ring-purple-500 p-3 text-sm shadow-sm"
              ...
              <div>
                ...
                <input v-model="form.otras_actividades" id="otras_actividades" type="text"
                  class="w-full rounded-lg border-gray-200 focus:border-purple-500 focus:ring-purple-500 p-3 text-sm shadow-sm"
              ...
              <div>
                ...
                <textarea v-model="form.descripcion_breve" id="descripcion_breve"
                  class="w-full rounded-lg border-gray-200 focus:border-purple-500 focus:ring-purple-500 p-3 text-sm shadow-sm"
                  placeholder="Descripción breve de la empresa" rows="4"></textarea>
              </div>

              <div>
                <label for="interesado_en" class="block text-sm font-medium text-gray-700">Interesado en</label>
                <select v-model="form.interesado_en" id="interesado_en"
                  class="w-full rounded-lg border-gray-200 focus:border-purple-500 focus:ring-purple-500 p-3 text-sm shadow-sm">
              ...
              <div>
                ...
                <select v-model="form.estado_actual" id="estado_actual"
                  class="w-full rounded-lg border-gray-200 focus:border-purple-500 focus:ring-purple-500 p-3 text-sm shadow-sm">
                  <option value="">Seleccione una opción</option>
